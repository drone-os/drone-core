...
impl CStr {
  ...
  /// the `CString::new("Hello").unwrap().as_ptr()` expression is evaluated.  To
  ...
  /// this C string has.
  ///
  /// > **Note**: This method is currently implemented as a constant-time cast,
  /// > but it is planned to alter its definition in the future to perform the
  ...
  ///
  /// > **Note**: This method is currently implemented as a 0-cost cast, but it
  /// > is planned to alter its definition in the future to perform the length
  ...
  /// > after a constant-time cast, but it is planned to alter its definition in
  /// > the future to perform the length calculation in addition to the UTF-8
